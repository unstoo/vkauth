(function(){
  ...
  var AuthButton = {  
        ...
        handler: function() {
            var API = "https://oauth.vk.com/authorize?",
                ...
                display = "popup",
                v = "5.52";   
            window.location = `${API}client_id=${oAuth}&scope=${scope}&redirect_uri=${redirect}&$display={display}&v=${v}&response_type=token`;
        }           
    };  
  ...
  var JSONP = { 
    getFriends: function(count) {
      ...
      var query = `https://api.vk.com/method/friends.get?fields=true&order=random&count=${count}&v=5.52&access_token=1205819480d97eecb9123072c6d3ff63b9cac2b75cbdc6206e275a1e90e99140c937942870d37784d776b&callback=JSONPCB`
